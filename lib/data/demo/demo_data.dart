...
Map<String, List<Map<String, dynamic>>> demoBlocks() => {
      ...
      'l-math-3': [
        ...
        _text(
          ...
          body: 'هي مجموعة القيم التي تقبل الدالة حسابها. مثلًا الدالة '
              'f(س) = ١ ÷ س غير معرّفة عند س = ٠ لأن القسمة على صفر مستحيلة.',
        ),
        _video(
          'b-m3-3',
          'l-math-3',
      ...
      'l-math-4': [
        _text(
          ...
          body: 'المشتق يقيس سرعة تغيّر الدالة. هندسيًا هو معامل توجيه '
              'المماس للمنحنى عند نقطة.',
        ),
        _text(
          'b-m4-2',
          'l-math-4',
          ...
          body: 'إذا كان المشتق موجبًا على مجال فالدالة متزايدة عليه، وإذا '
              'كان سالبًا فالدالة متناقصة. وانعدام المشتق مع تغيّر إشارته '
              'يدلّ على قيمة حدّية (قصوى أو دنيا).',
        ),
        _quiz(
          'b-m4-3',
          'l-math-4',
