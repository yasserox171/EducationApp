...
[
  {
    ...
    "data": {
      "heading": "مقدمة",
      "body": "مساحة الدائرة هي $$A = \\pi r^2$$ حيث r نصف القطر."
    }
  },
  {
...
> **المعادلات الرياضية** تُخزَّن داخل `body` (و`heading`) كنصّ LaTeX محاط
> بـ `$$`. الخادم يتعامل معها كنصّ عادي — لا يحتاج أي معالجة. التطبيق يرسمها
> على الجهاز، فتعمل في الوضع الأوفلاين تمامًا كما في الأونلاين.
